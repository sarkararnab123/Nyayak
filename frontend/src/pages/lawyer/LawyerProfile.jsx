            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <label className="space-y-2 md:col-span-1">
                  <span className="text-sm">Bar Council Reg. No</span>
                  <input className="w-full px-4 py-2 rounded-lg border bg-transparent" {...register("bar_reg_no", { required: true })} />
                </label>
                <label className="space-y-2 md:col-span-1">
                  <span className="text-sm">Specialization</span>
                  <select className="w-full px-4 py-2 rounded-lg border bg-transparent" {...register("specialization", { required: true })}>
                ...
                <label className="space-y-2 md:col-span-1">
                  ...
                  <input type="number" min="0" className="w-full px-4 py-2 rounded-lg border bg-transparent" {...register("years_practice", { required: true })} />
                </label>
                <label className="space-y-2 md:col-span-1">
                  <span className="text-sm">Court Name</span>
                  <div className="flex items-center gap-2">
                    <Building2 className="w-4 h-4 text-slate-500" />
                    <input className="w-full px-4 py-2 rounded-lg border bg-transparent" {...register("court_name", { required: true })} />
                  </div>
                </label>
                <label className="space-y-2 md:col-span-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <input className="w-full px-4 py-2 rounded-lg border bg-transparent" placeholder="LL.B (XYZ Univ), LL.M (ABC Univ)" {...register("education")} />
                  </div>
                </label>
                <label className="space-y-2 md:col-span-1">
                ...
                <label className="space-y-2 md:col-span-1">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <input className="w-full px-4 py-2 rounded-lg border bg-transparent" placeholder="e.g., 120+" {...register("reviews")} />
                  </div>
                </label>
                <label className="space-y-2 md:col-span-1">
